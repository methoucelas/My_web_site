					...
					<table id="example" class="table table-striped table-bordered table-hover" style="width:100%">
						...
						<tbody>
							<?php $i = 1; foreach ($groups as $value): ?>
								<tr>
									<td><?= $i++; ?></td>
									<td><?= $value['group_name']; ?>groupe name</td>
									<td><?= $value['permission']; ?>Permission</td>
									<td>
										<div class="dropdown">
											<button type="button" class="btn btn-info dropdown-toggle" data-bs-toggle="dropdown">Options</button>
											<div class="dropdown-menu">
												<a class="dropdown-item text-info" href="#" data-bs-toggle="modal" data-bs-target="#update_<?= $value['idGroup']; ?>">Modifier</a>
												<a class="dropdown-item text-info" href="#" data-bs-toggle="modal" data-bs-target="#detail_<?= $value['idGroup']; ?>">permission</a>
												<a class="dropdown-item text-danger" href="#" data-bs-toggle="modal" data-bs-target="#delete_<?= $value['idGroup']; ?>">Supprimer</a>
											</div>
										</div>
									</td>
								</tr>
								...
								<!-- Modal Modifier -->
								<div class="modal fade" id="update_<?= $value['idGroup']; ?>" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
									<div class="modal-dialog modal-lg">
										<div class="modal-content">
											...
											<form action="<?= base_url('Groups/Update_groups') ?>" method="POST">
												<input type="hidden" name="idGroup" value="<?= $value['idGroup']; ?>">
                                               ...
                                               <input type="text" class="form-control" name="group_name" placeholder="name of group" required="">
													...
													<div class="form-floating">
														<textarea class="form-control" name="permission" id="floatingTextarea" style="height: 100px;" required><?= $value['permission']; ?></textarea>
...
<div class="modal fade" id="detail_<?=$value['idGroup']?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" data-bs-backdrop="static">
...
<div class="modal-footer">
  <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Fermer</button> 
                               ...
                               <!-- Modal Supprimer -->
								...
								<div class="modal fade" id="delete_<?= $value['idGroup']; ?>" tabindex="-1" aria-hidden="true" data-bs-backdrop="static">
									<div class="modal-dialog modal-lg">
										<div class="modal-content">
											<div class="modal-header">
