                                            ...
                                            <form action="<?= base_url('Mode_payement/UpdateModePayement') ?>" method="POST">
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-floating">
                                                        <input type="text" class="form-control" name="description" id="description_<?= $value['id_mode_payement']; ?>" value="<?= $value['description']; ?>" required>
                                                        <label for="description_<?= $value['id_mode_payement']; ?>">Description</label>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <form action="<?= base_url('Mode_payement/DeleteModePayement') ?>" method="POST">
                                                <input type="hidden" name="id_mode_payement" value="<?= $value['id_mode_payement']; ?>">
                                                <div class="modal-body">
                                                    <p>Voulez-vous vraiment supprimer le mode de paiement "<?= $value['description']; ?>" ?</p>
